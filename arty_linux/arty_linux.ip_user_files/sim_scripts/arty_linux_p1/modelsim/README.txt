...
#
# Generated by export_simulation on Sat Jul 15 12:29:15 IST 2017
#
################################################################################
...
switch to the './arty_linux_p1.sh' script.

./arty_linux_p1.sh -reset_run
...
./arty_linux_p1.sh -noclean_files

For more information on the script, please type './arty_linux_p1.sh -help'.
