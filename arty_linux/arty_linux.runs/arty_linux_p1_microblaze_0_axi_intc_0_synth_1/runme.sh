...
HD_PWD='/home/ramprasad/arty_projects_10-7-2017/arty_linux/arty_linux.runs/arty_linux_p1_microblaze_0_axi_intc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log arty_linux_p1_microblaze_0_axi_intc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source arty_linux_p1_microblaze_0_axi_intc_0.tcl
