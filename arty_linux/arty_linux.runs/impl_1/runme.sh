...
HD_PWD='/home/ramprasad/arty_projects_10-7-2017/arty_linux/arty_linux.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log arty_linux_p1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source arty_linux_p1_wrapper.tcl -notrace
