...
HD_PWD='/home/ramprasad/arty_projects_10-7-2017/arty_linux/arty_linux.runs/arty_linux_p1_axi_timer_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log arty_linux_p1_axi_timer_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source arty_linux_p1_axi_timer_0_0.tcl
